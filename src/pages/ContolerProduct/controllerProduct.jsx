...
import {Autocomplete, FormLabel, Grid, Input, Select, TextField} from "@mui/joy";
...
const ControllerProduct = () => {
    ...
    return (
        <Grid container spacing={2} className='control-row' justifyContent="center" alignItems="flex-start" sx={{ minHeight: '100vh', padding: 2 }}>
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className='control-row'>
                        <div className='col-lg-12'>
                            ...
                            <Input variant="outlined" className="input-box"
                                   {...register("precios", {required: true})}
                            />
                    ...
                    <div className='control-row control-input-img'>
                        <div className='col-lg-12'>
                            ...
                            <input type="file" className="input-box-img" style={{marginBottom: '10px'}}
                                   {...register("fotoArray", {required: true})}
                                   onChange={handleFileChange}
                            />
                            {errors.foto && <p className='msg-error'>{errors.foto.message}</p>}
                            {imagePreview && <img src={imagePreview} alt="Preview" style={{ marginTop: '10px', width: '100%', height: '20px' }} />}
                            {!imagePreview && <div style={{ height: '100px', width: '100%', border: '1px solid #ccc', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>No image selected</div>}                        </div>
                    </div>
                    <Button type='submit' variant="outlined" color="neutral" disabled={isAdding}>
                        {editingProduct ? 'Actualizar' : 'Confirmar'}
                    </Button>
                </form>
            </div>
            <Grid container spacing={2} className='control-row' justifyContent="center" alignItems="flex-start"
